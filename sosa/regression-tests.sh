...
tests=(
  ...
  4   'text/html,*/*;q=0.8'          '/sosa.ttl'    200  'text/turtle; charset=utf-8'  "$base/sosa.ttl"
  5   'text/html,*/*;q=0.8'          '/om'          200  'text/turtle; charset=utf-8'  "$base/om"
  ...
  16  'text/html'                    '/sosa.ttl'    200  'text/turtle; charset=utf-8'  "$base/sosa.ttl"
  17  'text/html'                    '/om'          406  '-'                           '-'
  ...
  24  ''                             ''             200  'text/turtle; charset=utf-8'  "$base/"
  25  ''                             '/'            200  'text/turtle; charset=utf-8'  "$base/"
  26  ''                             '/sosa'        200  'text/turtle; charset=utf-8'  "$base/sosa"
  27  ''                             '/sosa.html'   200  'text/html; charset=utf-8'    'https://www.w3.org/TR/vocab-ssn/'
  28  ''                             '/sosa.ttl'    200  'text/turtle; charset=utf-8'  "$base/sosa.ttl"
  29  ''                             '/om'          200  'text/turtle; charset=utf-8'  "$base/om"
  30  ''                             '/Actuation'   200  'text/turtle; charset=utf-8'  "$base/Actuation"
  31  ''                             '/prov'        200  'text/turtle; charset=utf-8'  "$base/prov/"
  32  ''                             '/sosa?query'  200  'text/turtle; charset=utf-8'  "$base/sosa?query"
  33  ''                             '/x?y'         200  'text/turtle; charset=utf-8'  "$base/x?y"
  34  ''                             '/x/y'         404  '-'                           '-'
  35  ''                             '/?foo'        200  'text/turtle; charset=utf-8'  "$base/?foo"
  36  'text/html,text/turtle'        '/'            200  'text/turtle; charset=utf-8'  "$base/"
  37  'application/rdf+xml'          '/'            200  'application/rdf+xml; qs=0.9' "$base/"
  38  'text/turtle'                  '/hosts'       200  'text/turtle; charset=utf-8'  "$base/hosts"
  39  '*/*'                          '/'            200  'text/turtle; charset=utf-8'  "$base/"
  40  'text/html,*/*;qs=0.8'         '/x?term=y'    404  '-'                           '-'
  41  'text/turtle,text/html;qs=0.1' '/'            200  'text/turtle; charset=utf-8'  "$base/"
)
