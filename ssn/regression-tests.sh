...
tests=(
  ...
  4   'text/html,*/*;q=0.8'          '/ssn.ttl'     200  'text/turtle; charset=utf-8'  "$base/ssn.ttl"
  5   'text/html,*/*;q=0.8'          '/dul'         200  'text/turtle; charset=utf-8'  "$base/dul"
  ...
  16  'text/html'                    '/ssn.ttl'     200  'text/turtle; charset=utf-8'  "$base/ssn.ttl"
  ...
  26  ''                             '/ssn'         200  'text/turtle; charset=utf-8'  "$base/ssn"
  27  ''                             '/ssn.html'    200  'text/html; charset=utf-8'    'https://www.w3.org/TR/vocab-ssn/'
  28  ''                             '/ssn.ttl'     200  'text/turtle; charset=utf-8'  "$base/ssn.ttl"
  29  ''                             '/dul'         200  'text/turtle; charset=utf-8'  "$base/dul"
  30  ''                             '/System'      200  'text/turtle; charset=utf-8'  "$base/System"

  32  ''                             '/ssn?query'   200  'text/turtle; charset=utf-8'  "$base/ssn?query"
